...
public abstract class ScoreDatabase extends RoomDatabase {
    ...
    private static ScoreDatabase create(final Context context) {
         return  Room.databaseBuilder(context, ScoreDatabase.class, DB_NAME).allowMainThreadQueries().fallbackToDestructiveMigration().build();
